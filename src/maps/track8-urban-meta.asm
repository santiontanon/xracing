...
track_waypoints:
    ...
    db 27, 5, WAYPOINT_RIGHT, 120
    db 33, 10, WAYPOINT_DOWN, 90
    db 34, 16, WAYPOINT_DOWN, 112
    db 7, 29, WAYPOINT_UP, 120
    db 42, 22, WAYPOINT_RIGHT, 90
    ...
    db 61, 35, WAYPOINT_DOWN, 120
    db 53, 42, WAYPOINT_LEFT, 90
